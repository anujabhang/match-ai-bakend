...
import static com.anuj.match_ai_backend.utils.Utils.generateMyersBriggsTypes;
import static com.anuj.match_ai_backend.utils.Utils.selfieTypes;
...
//            OllamaChatResponse response = chatClient.call(new Prompt(prompt,
//                    OllamaChatOptions.builder().withFunction("saveProfile").build()));
